...
Label(tab_manager, text='Username:').grid(row=1, column=1)
Label(tab_manager, text='Password:').grid(row=2, column=1)
username = StringVar()
password = StringVar()
username.set('admin')
password.set('admin')
...
Button(tab_manager, text='OK', command=enter).grid(row=3, column=1, columnspan=2, sticky='news')
